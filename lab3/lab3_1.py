...
def main():
    ...
    print(f"Интерполяционный многочлен Лагранжа: {lagrange_str}")
    print(f"Значение погрешности интерполяции: {lagrange_error_rate}")
    ...
    print(f"Интерполяционный многочлен Ньютона: {newton_str}")
    print(f"Значение погрешности интерполяции: {newton_error_rate}")
